...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Email
  email: {
    send: (subject, message, recipients, attachments, userId, letterheadConfig) => 
      ipcRenderer.invoke('email:send', { subject, message, recipients, attachments, userId, letterheadConfig }),
